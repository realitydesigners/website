...
export default function HologramMaterial({
	...
	side = "front",
	emissiveIntensity = 1, // Default value
}) {
	// shader uniforms
   ...
   void main()
   {
       ...
       */
       ...
       float direction =  ${
					transitionDirection === 1 ? "objectUv.y" : "1.0 - objectUv.y"
				};
       ...
       ${
					!blinking
						? ""
						: "finalColor = mix( finalColor, blinkColor, blink * ( 0.01 * clamp( uBlinkAlpha, 0., 10.) ) );"
				}
       ...
       ${
					!flashLine
						? ""
						: "finalColor = mix( finalColor, flashColor, flash * clamp( uFlashAlpha, 0., 1. ) );"
				}
