...
export const SubCategory = props => {
   ...
   return (
      <group position={position} rotation={[0, rotationY, 0]} onPointerOver={onHover}>
         ...
         <Text ref={textRef} position={[0, 0, -3]} color="black" fontSize={1.5} font="/Staatliches.ttf" anchorY="middle" maxWidth={6} lineHeight={0.9} textAlign="center">
            {title}
         </Text>
         <Line
            points={[
...
export const RefPost = props => {
   ...
   return (
      <group position={position}>
         <Crystal className="sub-crystal" position={[0, 0, 0]} scale={[1, 1, 1]} onPointerOut={onPointerOut} emissiveIntensity={isHighlighted ? 1 : 0.6} />
         <Text ref={textRef} position={[0, 0, -3]} color="black" fontSize={0.5} font="/Staatliches.ttf" textAlign="center" anchorY="middle" maxWidth={6}>
            {title}
         </Text>
      </group>
   );
