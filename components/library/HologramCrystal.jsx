...
const Crystal = ({ position, scale, onPointerOver, onPointerOut, onClick, emissiveIntensity = 1, shouldShowControls = false }) => {
   ...
   return (
      <mesh ref={meshRef} position={position} rotation={[Math.PI / 90, 0, 0]} scale={scale} onPointerOver={onPointerOver} onPointerOut={onPointerOut}>
