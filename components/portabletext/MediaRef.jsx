      ...
      case 'card-1':
         return (
            <div className="relative p-4 mb-6 ">
               ...
               {media?.team && (
                  <div className="relative rounded-b-xl -mt-12  pt-4 bottom-0 flex h-auto w-full  bg-gradient-to-t from-black to-transparent pl-4  text-gray-200">
                     ...
                     <Link href={`/media/${slug}`} className=" ml-4 inline-block cursor-pointer text-2xl font-bold text-gray-200">
                        →
                     </Link>
                  </div>
               )}
