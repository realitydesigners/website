            ...
            <div className="flex w-full items-center justify-center mb-8 ">
               <div className="relative md:w-4/5 lg:w-1/2 w-11/12 border bg-black rounded-2xl border-gray-600">
                  ...
                  <div className="relative p-3 z-20">
                     ...
                     {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
                     <svg xmlns="http://www.w3.org/2000/svg" className="h-12 -mt-8 w-12 text-white" viewBox="0 0 24 24" fill="currentColor" aria-label="Quote Icon">
                        <path d="M5 10h2V5h5V3H5zM11 10h2V5h5V3h-7z" />
                     </svg>
                     ...
                     {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
                     <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 -mb-4 text-white" viewBox="0 0 24 24" fill="currentColor" aria-label="Quote Icon">
                        <path d="M5 10h2V5h5V3H5zM11 10h2V5h5V3h-7z" />
                     </svg>
                  </div>
               </div>
