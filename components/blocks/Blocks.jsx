...
const Light = {
	block: {
		...
		h1: ({ children }) => (
			<div className="w-screen flex justify-center">
				<h1
					className={`${staatliches.className} mb-6 w-10/12 text-black text-4xl font-bold uppercase  leading-none tracking-wide md:w-3/4   lg:w-1/2  lg:text-5xl`}
				>
					{children}
				</h1>
			</div>
		...
		h2: ({ children }) => (
			<div className="w-screen flex justify-center">
				<h2
					className={`${staatliches.className} mb-6 w-11/12 text-black text-4xl font-bold uppercase  leading-none tracking-wide md:w-3/4   lg:w-1/2  lg:text-5xl`}
				>
					{children}
				</h2>
			</div>
		...
		h3: ({ children }) => (
			<div className="w-screen flex justify-center">
				<h2
					className={`${staatliches.className} mb-6  w-11/12 text-4xl font-bold  leading-none tracking-wide md:w-3/4   lg:w-1/2 lg:text-5xl`}
				>
					{children}
				</h2>
			</div>
...
const Blocks = ({ block }) => {
	...
	const renderBlock = () => {
		switch (_type) {
			case "headingBlock":
				return <HeadingBlock block={{ ...block, className: layout }} />;
			case "headingSplineBlock":
				return <HeadingSplineBlock block={{ ...block, className: layout }} />;
			case "contentBlock":
